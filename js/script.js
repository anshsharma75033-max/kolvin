  ...
  jQuery(document).ready(function ($) {
    ...
    function checkScrolling(tabs) {
      var totalTabWidth = parseInt(
          tabs.children(".default-tabs-navigation").width(),
        ),
...
===================================*/
  ...
  const openPopupBtn = document.getElementById("openEnquiryPopup");
  const closePopupBtn = document.getElementById("closeEnquiryPopup");
